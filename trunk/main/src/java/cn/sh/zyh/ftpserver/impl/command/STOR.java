...
public class STOR implements ICommand {
	public static final String COMMAND_NAME = "STOR";

	/** The debug logger instance. */
	private final Logger logger = LoggerFactory.getLogger("STOR");
	...
	public void execute(String line, StringTokenizer st, FtpSession session) {
		...
		// send file
		try {
			handler.receiveFile(representation, file);
